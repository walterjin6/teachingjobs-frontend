      ...
      <Scroll2Top>
        <Routes>
          <Route exact path="/" element={<Layout />}>
            ...
            <Route
              exact
              path="/school-career-advice/:careerAdvice?"
              element={<CareerAdvice />}
            />
            <Route
              exact
              path="/school-career-advice/"
              element={<Careeradvice2 />}
            />
            ...
            />
            <Route
              path="/principal-of-the-year-2023-nominations"
              element={<Nominate />}
            />
            ...
            <Route
              ...
              element={<WesternAustralia />}
            />
            <Route
              exact
              path="/south-australia/"
              element={<SouthAustralia />}
            />
            <Route
              exact
              path="/northern-territory/"
              element={<NorthernTerritory />}
            />
