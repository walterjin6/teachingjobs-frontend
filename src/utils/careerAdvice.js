const data =[
...
},
 {
  ...
  <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black;">Using PERMA pillars to support teachers</p>
  ...
  <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black;">Perhaps you could consider these five questions:</p>
  ...
  <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black;">Of course, answering these questions is not going to help you tick off things on your to-do list, nor is it going to solve systemic flaws that cause excessive admin. But what if, by reflecting on these questions every so often, you are able to shift your focus to what is working instead of what isn’t working.</p>
  <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black;">Perhaps that could be the moment you have a meaningful connection of conversation with a student and they remember it for the rest of their life. Perhaps these small shifts in mindset lead to more productive conversations in the staff room. Perhaps reflecting on how we support our wellbeing is the first step to shifting habits and moving towards a positive organisational culture.</p>
  <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black;">If you want to learn more, you must read the foundational book by Martin Seligman, <em>Flourish</em>. You can find more specific tools that map PERMA to both classroom and staff room strategies online.</p>
