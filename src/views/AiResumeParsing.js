...
const AiResumeParsing = () => {  window.location.replace("https://www.academicjobs.com/ai-recruitment/ai-resume-extraction");
  return (
    <div className="">
      <Helmet>
        <title>Worlds Best AI Resume Extraction & Parsing Tool</title>
        <meta
          name="description"
          content="Academic Jobs is the leading AI Resume Extraction Tool specializing in helping Higher Education Institutions, Research & Development (R&D) Industries, and many other sectors build useful Talent Pools."
        />
        <meta
          name="keywords"
          content="AI Resume Extraction, AI Resume Parsing, Number 1 AI Resume Extraction Tool, Number 1 AI Resume Parsing Tool, Convert Resume to Structured Data Talent Pool Management"
        />
      </Helmet>
...
export default AiResumeParsing;
