...
const FAQusa = () => {
    ...
    <div className="p-6 space-y-6">
      ...
      <Link className='text-[#f4a10c] mb-4 px-2'to='/USA/'>← Back</Link>
      <div>
        <h2 className="text-xl font-bold">What Is Academic Salary in USA - Academic Jobs USA FAQ</h2>
        <p>
      ...
      <div>
        <h2 className="text-xl font-bold">What Is the Salary of PhD Professor in USA?</h2>
      ...
      <div>
        <h2 className="text-xl font-bold">Are Professors Paid Well in USA?</h2>
        <p>
      ...
      <div>
        <h2 className="text-xl font-bold">Do You Need a PhD to Be a Professor in the US?</h2>
        <p>
      ...
      <div>
        <h2 className="text-xl font-bold">How Much Do Harvard Professors Make an Hour?</h2>
        <p>
      ...
      <div>
        <h2 className="text-xl font-bold">Is It Easy to Get a Professor Job in USA?</h2>
        <p>
      ...
      <div>
        <h2 className="text-xl font-bold">Is It Hard to Become a Professor in USA?</h2>
        <p>
      ...
      <div>
        <h2 className="text-xl font-bold">Do US Universities Hire Foreign Professors?</h2>
        <p>
