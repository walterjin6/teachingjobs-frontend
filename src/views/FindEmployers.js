  ...
  return (
    ...
    <div className='w-full h-full'>
      ...
      <div className="blurb text-left py-8">
        <h1 className="text-3xl font-bold py-4 px-7 bg-[#f4a10c] text-white rounded-full shadow-xl">Top Employers, Top Jobs and University Rankings</h1>
      ...
      <div className="region-container bg-white">
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">UNITED STATES</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div class="region-container">
        <div>
          <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">AUSTRALIA</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
            <ul>
            ...
            <ul>
              ...
              <li><Link to="https://www.academicjobs.com/employers/swimburne-university-of-technology/10541/
            ...
            <ul>
              ...
              <li className='text-[#003463] font-bold' ><Link to="/employers/queensland-university-of-technology/3786/">Queensland
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">AFRICA</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7  mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">ASIA</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">CANADA</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">UNITED KINGDOM</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">SOUTH AMERICA</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">NEW ZEALAND</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">MIDDLE EAST</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">INDIA</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
      ...
      <div>
        <h2 className="text-2xl font-bold py-3 px-7 border-2 border-[#f4a10c] text-[#f4a10c] rounded-full shadow-md  ">EUROPE</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7 mb-8">
          <ul>
