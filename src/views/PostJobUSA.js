...
const PostJobUSA = () => {  window.location.replace("https://www.academicjobs.com/usa/post-a-job");
  return (
    <div className="">
      <Helmet>
        <title>Post a job - USA Academics Recruitment</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="USA Academics Recruitment, Post Academic Jobs, Post a Job AcademicJobs"
        />
      </Helmet>
      <div className="blurb text-left pb-4 ">
        ...
        <div className="px-4">
          ...
          <div className="text-xl max-w-screen-xl mx-auto mb-4">
            <ul className="p-4 pt-0 md:mt-[-36rem] mb-[8rem] pl-4 bg-gray-200 rounded-b-3xl md:bg-none">
              <div className="text-xl ">
                <h1 className="text-[#00aeef] text-[2rem] space-y-4 md:text-[4.5rem] font-bold md:mt-8 md:pt-4 uppercase w-1/2 leading-[3.5rem]">
                  The most affordable USA uni job board
                </h1>

                <div
                  className=" md:pt-10 font-bold"
                  style={{ marginTop: "10px" }}
                >
                  Recruit academics & all Higher Ed staff with Academic Jobs.{" "}
                </div>
                <div className=" md:pt-2 md:pb-4 md:font-bold">
                  The fastest growing job board in USA higher education.{" "}
                </div>

                <div className=" pt-4 md:pb-10 text-blue-600">
        ...
        <div className="bg-gradient-to-b to-white from-orange-100 rounded-3xl mx-4">
      ...
      <div className="bg-gradient-to-t from-white to-amber-500 py-4 rounded-t-3xl mx-4">
        <div className="max-w-screen-xl mx-auto">
          <div className="newLine text-center max-w-screen-xl mx-auto ">
            <div className=" px-7 rounded-2xl text-center">
              <h2 className="newLine  text-2xl font-bold text-white pb-2">
                Job Listing Options
              </h2>
              <p>
      ...
      <div className="max-w-screen-lg mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center my-4 gap-16 pt-12 mt-10 pb-4">
          <div className="p-4 ">
            <div className="long-box p-4 rounded-3xl  text-[#00aeef]  mt-4">
              <h3 className=" text-2xl pb-4">
                Let us go above and beyond for&nbsp;you.
        ...
        <div className="max-w-screen-lg mx-auto">
          <div className="bg-gray-200 py-4 rounded-3xl mx-4 mt-16">
      ...
      <div className="max-w-screen-3xl mx-auto">
        <div className="cont1 md:flex md:flex-wrap grid-cols-1 grid justify-center my-4 md:gap-8 gap-3 pt-12 mb-10 pb-4 ">
          <div className="w-auto md:w-1/4 p-4 ">
            <div className="long-box p-4 rounded-3xl  text-[#00aeef]  mt-4">
              <h3 className=" text-2xl pb-4">
              ...
              <p className="text-gray-400">
                Join global leading institutions in finding top academic talent.
                Join the premiere league of top institutions that we have helped
                level up their recruitment.
              </p>
            </div>
          </div>
          <div className="w-auto md:w-1/4 pt-2">
