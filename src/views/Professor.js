...
import professorData from "../utils/professor.json";
import { Helmet } from "react-helmet";
const Professor = () => {
  const dispatch = useDispatch()
  let { professor } = useParams();
  professor = professor?.replace(/-/g, ' ')
  ...
  content = (
    <div className='flex-col gap-2'>
      ...
      <Link className='text-[#f4a10c] mb-4 ' to='/professor/'>← View all professor Jobs</Link>
