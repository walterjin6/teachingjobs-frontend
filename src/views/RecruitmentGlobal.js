...
const RecruitmentGlobal = () => {  window.location.replace("https://www.academicjobs.com/recruitment");
  return (
    <div className="">
      <Helmet>
        <title>
          Fastest growing Academic Job Board with the best customer service &
          support
        </title>
      ...
      <main>
        ...
        <section className="container mx-auto px-4 mt-12">
          <h2 className="text-left mb-4 md:px-8 text-xl font-bold">
            Connect with the {countryRegionPlural()} Academic Elite on the
            Premier Job Board
          </h2>
          <div className="text-col-2 rounded-2xl shadow-lg pb-12">
