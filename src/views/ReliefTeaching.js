      ...
      <main>
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div>
                <h1 className="text-4xl font-bold text-aj">
                  No. 1 Recruitment Platform for Teachers
                </h1>
                <p className="py-6">
                Teaching Jobs is the leading education recruitment platform, providing a superior service that benefits both schools and job seekers by efficiently connecting qualified relief teachers with institutions in need. 
        ...
        <section className="container mx-auto px-4 mt-12">
          ...
          <div className="card card-side bg-slate-100 shadow-xl my-16 px-6 grid sm:grid-cols-1 md:grid-cols-2">
            ...
            <div className="card-body w-full">
              ...
              Teaching jobs streamline the process for recruiters to easily find relief teachers through our talent pool. Our service ensures a quick and efficient connection between schools and qualified educators, saving time and guaranteeing a high standard of teaching.
              </p>
        ...
        <section>
          <h3 className="container mx-auto text-center py-8 px-4">
            ...
            <Link to="/relief-talent-pool" className="btn btn-aj">
