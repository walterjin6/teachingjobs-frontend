  ...
  return (
    ...
    <div className='w-full h-full'>
      ...
      <div className="blurb text-left py-8 ">
        <h1 className="bg-[#f4a10c] text-white rounded-3xl font-bold text-lg md:text-2xl px-7">AcademicJobs Sitemap</h1>
      ...
      <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 ">Top Cities for Uni Jobs</h2>
      <div className="cate-group section23 ">
        <div className="widget__text-block">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/professor/" >Find Professor Jobs</Link></h2>
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/student/">Find Student jobs on Campus</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/UK/" >Find UK Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/South-America/" >Find South America Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/New-Zealand/" >Find New Zealand Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/Middle-East/" >Find Middle East Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/India/" >Find India Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/Europe/" >Find Europe Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/Canada/" >Find Canada Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/Africa/" >Find Africa Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/Asia/" >Find Asia Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <h2 class="py-3 px-7 bg-[#f4a10c] text-white rounded-3xl font-bold text-xl md:text-xl lg:text-xl text-transform: uppercase">Academic Jobs Australia</h2>
      <div class=" mt-[1rem] pb-8"><ul class="faculty-container flex flex-wrap gap-4 items-center justify-center text-[#f4a10c] "><ul class="w-full  md:w-auto flex items-center  justify-center gap-4"><li class=""><a href="/Australia/lecturer/"> Lecturer</a></li><li class=""><a href="https://www.academicjobs.com/Australia/research/"> Research </a></li><li class=" "><a href="https://www.academicjobs.com/Australia/professor/"> Professor</a></li></ul><li><a href="https://www.academicjobs.com/Australia/executive/"> Executive</a></li><li><a href="https://www.academicjobs.com/Australia/admin/">Admin</a></li><li><a href="https://www.academicjobs.com/Australia/hr/"> HR</a></li><li><a href="https://www.academicjobs.com/Australia/student/"> Student</a></li><li><a href="https://www.academicjobs.com/online/"> Online </a></li></ul></div>

      <h1 class="py-3 px-7 bg-[#f4a10c] text-white rounded-3xl font-bold text-xl md:text-xl lg:text-xl text-transform: uppercase">USA Academic Jobs Online</h1>
      <div class=" mt-[1rem] pb-8"><ul class="faculty-container flex flex-wrap gap-4 items-center justify-center text-[#f4a10c] "><ul class="w-full  md:w-auto flex items-center  justify-center gap-4"><li><a href="/USA/lecturer/"> Lecturer</a></li><li><a href="https://www.academicjobs.com/USA/research/"> Research </a></li><li><a href="https://www.academicjobs.com/USA/professor/"> Professor</a></li></ul><li><a href="https://www.academicjobs.com/USA/executive/"> Executive</a></li><li><a href="https://www.academicjobs.com/USA/admin/">Admin</a></li><li><a href="https://www.academicjobs.com/USA/hr/"> HR</a></li><li><a href="https://www.academicjobs.com/USA/student/"> Student</a></li><li><a href="https://www.academicjobs.com/online/"> Online </a></li></ul></div>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
            <ul>
              ...
              <li className='mb-1 text-[#f4a10c] font-bold'>New South Wales</li>
              <li><Link class="footer-nav__link" href="/employers/the-university-of-sydney/3171/">The
            ...
            <ul>
              ...
              <li><Link to="/employers/swimburne-university-of-technology/3870/
              ...
              <li><Link to="/employers/company/deakin-university/3856/
            ...
            <ul>
              ...
              <li><Link to="/employers/queensland-university-of-technology/3786/">Queensland
