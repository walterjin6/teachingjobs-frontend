...
const SiteMap = () => {
  ...
  return (
    ...
    <div className='w-full h-full text-2xl pd-1 space-y-6'>
        ...
        <div className="widget__text-block">
          <div className="faculty-container grid-cols-1 grid md:grid-cols-4 gap-6 py-2 px-7">
            ...
            <div className="column">
              <ul className="">
                <li className='mb-2 mt-4'><Link to="https://www.academicjobs.com/employers/queensland-university-of-technology/3786/" className='text-[#003463] font-bold mb-2'>Queensland University of Technology (QUT)</Link></li>
            ...
            <div className="column">
              <ul className="">
                <li className='mb-2 mt-4'><Link to="https://www.academicjobs.com/employers/university-of-california-san-diego/3149/" className='text-[#192847] font-bold mb-2'>University of California San Diego</Link></li>
                <ul className="innerUL">
          ...
          <div className="faculty-container grid-cols-1 grid md:grid-cols-4 gap-6 py-2 px-7 ">
            <div className="column">
              <ul className="">
                ...
                <ul className="pb-4">
                  ...
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/stanford-university/3101/" >	Stanford University</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-of-cambridge/12635/" >	University of Cambridge</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/massachusetts-institute-of-technology/3103/" >MIT</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-of-california-berkeley/3105/" >	University of California, Berkeley</Link></li>
            ...
            <div className="column">
              <ul className="">
                ...
                <ul className="innerUL">
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/princeton-university/3104/" >	Princeton University</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-of-oxford/3099/" >	University of Oxford</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/columbia-university/3127/" >	Columbia University</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/caltech/3128/" >Caltech</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/University-of-Chicago/3126/" >	University of Chicago</Link></li>
            ...
            <div className="column">
              <ul className="">
                ...
                <ul className="innerUL">
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/yale-university/3125/" >	Yale University</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/Cornell-University/3138/" >Cornell University</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-of-california-los-angeles/3136/" >UCLA</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-of-pennsylvania/3131/" >UPenn</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/johns-hopkins-university/3130/" >Johns Hopkins University (JHU)</Link></li>
            ...
            <div className="column">
              <ul className="">
                ...
                <ul className="innerUL">
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-college-london/12527/" >University College London (UCL)</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/eth-zurich/3132/" >ETH Zurich</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/university-of-tokyo/3155/" >The University of Tokyo (UTokyo)</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/new-york-university-nyu/3144/" >New York University (NYU)</Link></li>
                  <li className='pb-6'><Link to="https://www.academicjobs.com/employers/duke-university/3139/" >	Duke University (Duke)</Link></li>
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold mb-2 py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/hr/">Find Academic HR jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize">
      ...
      <div className="bg-white flex flex-col  ">
        <h2 className="text-1xl font-bold mb-2 py-1 px-7 bg-[#f4a10c] text-white rounded-3xl mt-20 "><Link to="/UK/" >Find UK Jobs</Link></h2>
        <ul className=" mb-8 text-left columns-1 md:columns-4  md:gap-2 py-2 px-7 h-auto w-full text-transform: capitalize ">
      ...
      <div class=" mt-[1rem] pb-8"><ul class="faculty-container flex flex-wrap gap-6 items-center justify-center text-[#f4a10c] "><ul class="w-full  md:w-auto flex items-center  justify-center gap-6"><li className='pb-6'><a href="/USA/lecturer/"> Lecturer</a></li><li className='pb-6'><a href="https://www.academicjobs.com/USA/research/"> Research </a></li><li className='pb-6'><a href="https://www.academicjobs.com/USA/professor/"> Professor</a></li></ul><li className='pb-6'><a href="https://www.academicjobs.com/USA/executive/"> Executive</a></li><li className='pb-6'><a href="https://www.academicjobs.com/USA/admin/">Admin</a></li><li className='pb-6'><a href="https://www.academicjobs.com/USA/hr/"> HR</a></li><li className='pb-6'><a href="https://www.academicjobs.com/USA/student/"> Student</a></li><li className='pb-6'><a href="https://www.academicjobs.com/online/"> Online </a></li></ul></div>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
            ...
            <ul>
              ...
              <li className='pb-6'><Link to="/employers/queensland-university-of-technology/3786/">Queensland
