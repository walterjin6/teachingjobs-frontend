...
const Student = () => {  window.location.replace("https://www.academicjobs.com/student");
  ...
  window.location.replace(`https://www.academicjobs.com/student/${student?.replace(/\W+/g, '-').toLowerCase()}`);
  ...
  content = (
    <div className='flex-col gap-2'>
      ...
      <Link className='text-[#00aeef] mb-4 ' to='/student/'>← View all Student Jobs</Link>
