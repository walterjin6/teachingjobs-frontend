...
const Students = () => {
  ...
  return (
    ...
    <div className="">
      <Helmet>
        <title>Student Jobs on Campus Australia</title>
        <meta name="description" content="Searching for a flexible, fulfilling employment on campus? Examine hundreds of student positions offered by your institution in a range of areas and disciplines. Apply now to get useful job experience and competencies with Student Jobs on Campus Australia. " />
        <meta name="keywords" content="Student Jobs on Campus Australia, Student Jobs at University Australia" />
      </Helmet>
      <div className="blurb text-left py-8 ">
        <h1 className=" font-bold text-lg md:text-2xl py-4 px-7 bg-[#f4a10c] text-white rounded-full shadow-xl ">Student Jobs on Campus Australia</h1>
      ...
      <SearchResults q={{ q: "student", l: "Australia" || 0 }} />
    </div>
