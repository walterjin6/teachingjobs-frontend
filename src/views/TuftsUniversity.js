            ...
            <div className="relative">
                ...
                >
                    <div className="max-w-screen-xl mx-auto py-12 px-6 text-gray-700">
                        ...
                        <p>
                            Jobs at Tufts are located in Medford, Massachusetts. It has more than 11,000 undergraduate and graduate students, and offers more than 150 majors and minors in nine colleges and schools. Tufts jobs are also known for its experiential learning model, which integrates classroom instruction with co-op, internships, research, service, and global opportunities. Tufts jobs are classified as an R1 research by the Carnegie Classification of Institutions of Higher Education, and has produced many prestigious scholars and awards. It also has a strong commitment to social justice and community engagement, inspired by its urban and global mission. Tufts University’s athletic teams are the Jumbos, and they compete in the NCAA Division III New England Small College Athletic Conference in various sports, including basketball, hockey, soccer, and lacrosse. The men’s lacrosse team has won three national championships. Start your Tufts careers on AcademicJobs today. Academic Jobs is the leading online platform for finding and applying for Tufts university careers. Here you can browse through hundreds of Tufts University jobs postings from various campuses, schools, and departments. Whether you are looking for a faculty, staff, or student position, you will find your Tufts employment here. </p>
