...
const UKpositions = () => {  window.location.replace("https://www.academicjobs.com/uk");
  ...
  window.location.replace(`https://www.academicjobs.com/uk/${ukpositions?.replace(/\W+/g, '-').toLowerCase()}`);
  ...
  content = (
    <div className='flex-col gap-2'>
      ...
      <SearchResults q={{ q: Name, l: "United Kingdom" }} />
    </div>
  )
  return <div className='overflow-y w-full'>{content}</div>
}
export default UKpositions
