...
const RecruitmentGlobal = () => {  window.location.replace("https://www.academicjobs.com/asia/employers");
  return (
    <div className="">
      <Helmet>
        ...
        <meta
          name="description"
          content="Browse through our comprehensive list of universities from around the world and find the best one for you. Whether you want to study in Australia, Canada, UK, Asia, or anywhere else, we have the information you need to make an informed decision."
        />
        <meta
          name="keywords"
              ...
              <div className="hero-content flex-col xl:flex-row-reverse mx-auto max-w-full">
                ...
                <div>
                  ...
                  <p className="py-6">
                    ...
                    faculty or staff of leading Asian institutions, such as
                    Peking University, National University of Singapore, The
                    University of Hong Kong, KAIST, and many more. Whether you
                    are interested in teaching, research, administration, or
